...
- Enriched sources are sorted by descending score within `enrich_sources/2` so callers always receive results in rank order without needing to sort themselves.
